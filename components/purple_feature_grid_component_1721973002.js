...
Vue.component("purple_feature_grid_component_1721973002", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm" :class="textPrimaryStyle">Stay ahead of the curve with our cutting-edge blockchain monitoring system that provides real-time updates on the latest transactions, blocks, and activities across multiple blockchain networks.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm" :class="textPrimaryStyle">Leverage our powerful data analytics capabilities to gain valuable insights into blockchain trends, patterns, and anomalies, empowering you to make informed decisions and capitalize on emerging opportunities.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 font-medium" :class="textSecondaryStyle">Customizable Notification System</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm" :class="textPrimaryStyle">Tailor our notification system to your specific needs, ensuring you never miss critical blockchain events or activities that could impact your business or investments.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container"><h4 id="feature-4-title" class="flex-1 font-medium" :class="textSecondaryStyle">Comprehensive Reporting</h4></div>
            </div>
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm" :class="textPrimaryStyle">Generate detailed reports on blockchain activities, transactions, and performance metrics, providing you with a holistic view of the blockchain landscape and enabling data-driven decision-making.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            ...
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm" :class="textPrimaryStyle">Our platform supports a wide range of blockchain networks, allowing you to monitor and analyze data across multiple chains, unlocking new opportunities and enhancing your understanding of the decentralized ecosystem.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            ...
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm" :class="textPrimaryStyle">With robust security measures and a reliable infrastructure, you can trust our platform to handle your sensitive blockchain data with utmost confidentiality and integrity.</p></div>
        </div>
    </div>`,
        data() {
            return {
